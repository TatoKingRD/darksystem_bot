...
const ARACLAR = [
  ...
  },
  {
    ...
    function: {
      name: 'mesaj_gonder',
      description: 'Belirtilen kanala mesaj veya duyuru gönderir',
      parameters: {
        type: 'object',
        properties: {
          kanal_adi: { type: 'string', description: 'Mesajın gönderileceği kanal adı' },
...
const ONAYSIZ = [
  'kanal_listele', 'kanal_temizle', 'kanal_tek_temizle', 'kanal_emoji_ekle',
  'kanal_kategori_duzenle', 'sunucu_istatistik', 'rol_listele', 'uye_listele',
